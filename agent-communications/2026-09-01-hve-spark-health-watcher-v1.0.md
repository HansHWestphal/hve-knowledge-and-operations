# HVE DGX Spark Health Watcher — Final Operating State
...
It is a deterministic Python no-agent watcher. The two older profile-local
entrypoints remain only as compatibility shims and delegate to this file:
